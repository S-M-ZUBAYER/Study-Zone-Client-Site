...
const CourseCard = ({ course }) => {
    ...
    return (
        <article className="max-w-md mx-auto mt-4 shadow-lg border rounded-md duration-300 hover:shadow-sm" key={id}>
            ...
            <div className="flex items-center mt-2 pt-3 ml-4 mr-2">
                ...
                <div className="ml-3 text-start mb-3">
                    <span className="block text-gray-900">{author_name}</span>
