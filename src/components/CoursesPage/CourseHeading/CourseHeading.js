                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="flex flex-col  max-w-7xl justify-center items-center space-y-3 w-full ">
                        <div className="flex flex-col   md:items-start items-center justify-center  space-y-3 px-8 text-center ">
                            <div>
                                <h2 className="text-3xl mt-3 md:text-5xl font-bold text-amber-300 text-center ">
                                    <span className="text-lime-500">Courses</span> We Offer!!!</h2>
                                <p className="mx-10 font-medium mt-3 text-lg text-yellow-100">We understand that you need flexible course options to gather knowledge, career, and other life commitments. We offer a variety of ways for you to take courses so you can find the option that works best with your schedule, including courses that you got it in online. </p>
                            </div>
                        </div>
                        <div
