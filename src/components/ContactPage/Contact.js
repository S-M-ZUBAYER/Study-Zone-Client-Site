...
const Contact = () => {
    return (
        <div>
            <section className="min-h-screen text-slate-300 bg-white dark:bg-gray-900 bg-gradient-to-t from-black via-slate-800 to-gray-900">
                <div className="container px-6 py-10 mx-auto">
                    <div className="lg:flex lg:items-center lg:-mx-10">
                        <div className="lg:w-1/2 lg:mx-10">
                            <h1 className="text-3xl font-semibold text-gray-400 capitalize dark:text-white lg:text-5xl">Let’s talk</h1>
                        ...
                        <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10 text-slate-300">
